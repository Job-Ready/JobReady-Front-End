            ...
            <Plain
              email={
                email !== undefined && email.length !== 0
                  ? email
                  : resumes[getResumeIndex].email
              }
              phone={
                phone !== undefined && phone.length !== 0
                  ? phone
                  : resumes[getResumeIndex].phone
              }
              linkedin={
                linkedin !== undefined && linkedin.length !== 0
                  ? linkedin
                  : resumes[getResumeIndex].linkedin
              }
              portfolio={
                portfolio !== undefined && portfolio.length !== 0
                  ? portfolio
                  : resumes[getResumeIndex].portfolio
              }
              country={
                country !== undefined && country.length !== 0
                  ? country
                  : resumes[getResumeIndex].country
              }
              repos={
                repos !== undefined && repos.length !== 0
                  ? repos
                  : resumes[getResumeIndex].repos
              }
              fullname={
                fullname !== undefined && fullname.length !== 0
                  ? fullname
                  : resumes[getResumeIndex].fullname
              }
              title={
                title !== undefined && title.length !== 0
                  ? title
                  : resumes[getResumeIndex].title
              }
              workexperiences={
                workexperiences !== undefined && workexperiences.length !== 0
                  ? workexperiences
                  : resumes[getResumeIndex].workexperiences
              }
              projects={
                projects !== undefined && projects.length !== 0
                  ? projects
                  : resumes[getResumeIndex].projects
              }
              education={
                education !== undefined && education.length !== 0
                  ? education
                  : resumes[getResumeIndex].education
              }
              languages={
                languages !== undefined && languages.length !== 0
                  ? languages
                  : resumes[getResumeIndex].languages
              }
              skills={
                skills !== undefined && skills.length !== 0
                  ? skills
                  : resumes[getResumeIndex].skills
              }
            />
          ) : (
